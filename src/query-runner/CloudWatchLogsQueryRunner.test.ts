...
import { CloudWatchLogsAnomaliesQuery, CloudWatchLogsQuery, LogsMode, LogsQueryLanguage } from '../types';
...
describe('CloudWatchLogsQueryRunner', () => {
  ...
  describe('handleLogAnomaliesQueries', () => {
    ...
    it('processes log trend histogram data correctly', async () => {
      const response = JSON.parse(JSON.stringify(anomaliesQueryResponse));
